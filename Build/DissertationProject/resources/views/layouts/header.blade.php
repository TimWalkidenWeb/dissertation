<nav>
    ...
    <nav>
        ...
        @if(Auth::guest())
            ...
            <div class="login"> <a href="/new_student">Register</a></div>
            <div class="login"> <a href="{{'/learning_material'}}">Support</a></div>
            <div class="login"> <a href="{{url('/previous_projects')}}">Examples</a></div>
            <div class="login"> <a href="{{url('/project')}}">Topics</a></div>
        @elseif(Auth::user()->permission == 1)
            <div class="login"> <a href="{{url('/log_out')}}">Logout</a></div>
            <div class="login"> <a href="/new_staff">Register staff</a></div>
            <div class="login"> <a href="{{'/learning_section'}}">Support</a></div>
            <div class="login"> <a href="learning_section/create">Add Support</a></div>

            <div class="login"> <a href="{{url('/project')}}">Topics</a></div>
            <div class="login"> <a href="/new_project">Add Topic</a></div>

            <div class="login"> <a href="{{url('/previous_projects')}}">Examples</a></div>
            <div class="login"> <a href="/new_previous_project">Add Examples</a></div>
