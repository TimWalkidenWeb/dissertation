<nav>
    <div class="row">
        ...
        <div class="col-10 small-12">
            <div class="row">
                <h1 class="col-7 small-9">Edge Hill University Final Year Projects</h1>
                @if(Auth::guest())
            ...
            @elseif(Auth::user()->permission == 1 or 3)
                <div class="row nav small-hidden">
                    <div class="col-2"><a href="{{'/learning_section'}}">Project support</a></div>
                    <div class="col-2"><a href="/learning_section/create">Create learning section</a></div>
